...
func (r *IngressReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	case internalerrors.IsErrInvalidIngressSpec(err):
		r.Recorder.Eventf(originalFoundIngress, nil, "Warning", "InvalidIngressSpec", "Validate", "Ingress is not valid so skipping it: %v", err)
		return ctrl.Result{}, nil
	default:
		r.Recorder.Eventf(originalFoundIngress, nil, "Warning", "FailedGetIngress", "Reconcile", "Failed to get ingress from store")
		return ctrl.Result{}, err
	}
